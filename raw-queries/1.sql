...
SELECT COUNT(outlet_id) as branches_cnt FROM branches;
...
SELECT COUNT(outlet_id) as kiosks_cnt FROM kiosks;

SELECT o.address
FROM photo_stores ps
JOIN public.outlets o ON ps.outlet_id = o.id;

SELECT COUNT(outlet_id) as photostores_cnt FROM photo_stores;
