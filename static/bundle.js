...
/* harmony import */ var tabulator_tables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tabulator-tables */ "./node_modules/tabulator-tables/dist/js/tabulator_esm.js");
...
document.querySelectorAll(".query-execute").forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    ...
    for (var i = 0; i < queryResultCount; i++) {
      ...
      new tabulator_tables__WEBPACK_IMPORTED_MODULE_0__.TabulatorFull(queryResultDiv, {
        columns: columns,
        data: data,
        layout: "fitDataTable"
      });
...
function initializeTable(selector) {
  ...
  new tabulator_tables__WEBPACK_IMPORTED_MODULE_0__.TabulatorFull(selector, {
    data: tableData,
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfrontent_bundler"] = self["webpackChunkfrontent_bundler"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["bundle"], () => (__webpack_require__("./js/main.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["bundle"], () => (__webpack_require__("./scss/main.scss")))
